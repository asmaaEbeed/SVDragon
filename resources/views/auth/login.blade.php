...
@section('content')
    <div class="login-form col-md-12 col-xs-12 right-col-content">
        <p class="form-header text-white login-input-field">@lang('lang_v1.login')</p>
        <form method="POST" action="{{ route('login') }}" id="login-form">
            {{ csrf_field() }}
            <div class="form-group has-feedback {{ $errors->has('username') ? ' has-error' : '' }} login-input-field">
                @php
            ...
            <div class="form-group has-feedback {{ $errors->has('password') ? ' has-error' : '' }} login-input-field">
            ...
            <div class="form-group">
                <div class="checkbox icheck login-input-field">
                    <label>
            ...
            <div class="form-group login-input-field">
                <button type="submit" class="btn btn-primary btn-flat btn-login full-width">@lang('lang_v1.login')</button>
                
            </div>
            <div class="form-group login-input-field">
                @if(config('app.env') != 'demo')
                <a href="{{ route('password.request') }}" class="login-forget">
