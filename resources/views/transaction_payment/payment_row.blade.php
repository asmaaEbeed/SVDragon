        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              {!! Form::number("amount", $payment_line->amount, ['class' => 'form-control input_number', 'required', 'placeholder' => 'Amount', 'data-rule-max-value' => @num_format($payment_line->amount),'max'=>$payment_line->amount, 'data-msg-max-value' => __('lang_v1.max_amount_to_be_paid_is', ['amount' => $amount_formated])]); !!}
            </div>
          </div>
        </div>
        <div class="col-md-4">
