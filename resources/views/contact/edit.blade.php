  ...
  @endphp
    ...
    <div class="modal-body">
      ...
      <div class="row">
        ...
        <div class="col-md-4 mt-15">
            ...
            <label class="radio-inline">
                ...
                @lang('business.business_contact')
            </label>
        </div>
        <div class="col-md-4">
          <div class="form-group">
      ...
      <div class="col-md-3">
        ...
        <div class="col-md-4 commission_filed  customer_fields" >
            <div class="form-group business" style="display: none;">
                ...
                <div class="input-group">
                    ...
                    {!! Form::text('commission',$contact->commission != null ? @num_format($contact->commission) : null,['class'=>'form-control input_number']); !!}
                </div>
            </div>
        </div> 
      <div class="col-md-12">
