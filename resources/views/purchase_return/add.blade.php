			        ...
			        <tbody>
								@php
								  if($purchase->discount_type == 'percentage'){
										$price_percent = (1-($purchase->discount_amount)/100);
									}else{
										$price_percent=1;
									}
								@endphp
			            ...
			            <tr>
			              	...
			              	<td><span class="display_currency" data-currency_symbol="true">{{ $purchase_line->purchase_price_inc_tax * $price_percent }}</span></td>
			              	...
			              	<td>
					            ...
					            @if($purchase_line->product->enable_stock) 
			              		...
			              		@endif
					            >
					            <input type="hidden" class="unit_price" value="{{@num_format($purchase_line->purchase_price_inc_tax * $price_percent)}}">
			              	</td>
			              	<td>
