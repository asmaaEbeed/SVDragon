...
@section('content')
<section class="content no-print no-padding">
		...
		<div class="col-md-12 no-padding">
			<div class="row no-margin">
				<div class="@if(empty($pos_settings['hide_product_suggestion'])) col-md-6 @else col-md-10 col-md-offset-1 @endif no-padding">
					<div class="box box-solid mb-0 pos-selected-prod-all-area">
						<div class="box-body pb-0 no-padding">
				...
				<div class="col-md-6 no-padding">
					@include('sale_pos.partials.pos_numbers_keyboard')
