...
<div class="row no-margin">
	@if(!empty($categories))
		<div class="col-md-4 padding-5" id="product_category_div">
	...
	@if(!empty($brands))
		<div class="col-sm-4 padding-5" id="product_brand_div">
	...
	<div class="col-md-6 padding-5 hide" id="product_service_div">
	...
	<div class="col-sm-4 padding-5 @if(empty($featured_products)) hide @endif" id="feature_product_div">
