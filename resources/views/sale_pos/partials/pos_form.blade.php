...
<div class="row">
	<div class="col-sm-12 pos_product_div">
		...
		@endphp
		<table class="table table-condensed table-responsive pos-table" id="pos_table">
			<thead>
				<tr class="pos-table-thead">
					<th class="tex-center pos-table-product-col @if(!empty($pos_settings['inline_service_staff'])) col-md-3 @else col-md-4 @endif">	
						@lang('sale.product') @show_tooltip(__('lang_v1.tooltip_sell_product_column'))
					</th>
					
					<th class="text-center col-md-3 pos-table-qty">
						@lang('sale.qty')
					</th>
					<th class="pos-table-unit">
						@lang('sale.unit')
					</th>
					...
					<th class="text-center col-md-2">@lang('sale.price')</th>
					<th class="text-center col-md-2">@lang('sale.discount')</th>
					<th class="text-center col-md-2">
						@lang('sale.subtotal')
					</th>
