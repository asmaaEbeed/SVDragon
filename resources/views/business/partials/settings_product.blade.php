<div class="pos-tab-content">
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="form-group">
        <div class="checkbox" >
          <label id="enable_price_tax_lable">
            <input type="checkbox" name="enable_price_tax" value="1" id="enable_price_tax" {{$business->enable_price_tax?'checked':''}} class="input-icheck" >
            {{ __( 'lang_v1.enable_price_tax' ) }}
          </label>
        </div>
        <div class="checkbox" id="enable_tax_box">
          <label>
            {!! Form::checkbox('enable_tax_box', 1, $business->enable_tax_box, [ 'class' => 'input-icheck','id'=>'enable_tax_box']); !!} {{ __( 'lang_v1.enable_tax_box' ) }}
          </label>
        </div>
      </div>
    </div>
