...
{!! Form::open(['url' => action('ProductController@update' , [$product->id] ), 'method' => 'PUT', 'id' => 'product_add_form',
    ...
    @component('components.widget', ['class' => 'box-primary'])
        <div class="row">
            ...
            <div class="col-sm-4">
              <div class="form-group">
                {!! Form::label('actual_name1', __( 'unit.unit_name' ) . ':*') !!}
                {!! Form::text('actual_name[]', $product->unit->actual_name, ['class' => 'form-control', 'required','readonly', 'placeholder' => __( 'unit.name' )]); !!}
                <input type="hidden" name="product_ids[]" value="{{$all_products[0]['id']}}"> 
              </div>
            </div>
            <div class="col-sm-4"></div>
            <div class="col-sm-4">
              <div class="form-group">
                <label><span class="dsp_label">@lang('unit.exc_of_tax') :*</span></label>
                {!! Form::text('single_dsp', @num_format($all_products[0]->variations[0]->default_sell_price), ['class' => 'form-control input-sm dsp input_number', 'placeholder' => __('unit.exc_of_tax'), 'id' => 'single_dsp', 'required']); !!}
                {!! Form::text('single_dsp_inc_tax', @num_format($all_products[0]->variations[0]->default_sell_price) , ['class' => 'form-control input-sm hide input_number', 'placeholder' => __('product.inc_of_tax'), 'id' => 'single_dsp_inc_tax', 'required']); !!}
              </div>
            </div>
            <div class="clearfix"></div>
            <!-- first sub unit data -->
            <div class="col-sm-4">
              <div class="form-group">
                {!! Form::label('actual_name2', __( 'unit.subunit_name' ) . ':') !!}
                {!! Form::text('actual_name[]',array_key_exists(1,$all_products)?$sub_units[$all_products[1]['sub_unit_ids'][0]]['name']:null, ['class' => 'form-control',array_key_exists(1,$all_products)?'readonly':'' ,'placeholder' => __( 'unit.name' )]); !!}
                <input type="hidden" name="product_ids[]" value="{{array_key_exists(1,$all_products)?$all_products[1]['id']:''}}">
              </div>
            </div>
            <div class="col-sm-4">
              <div class="form-group">
                {!! Form::label('base_unit_multiplier2', __( 'lang_v1.times_base_unit' ) . ':') !!}
                {!! Form::number('base_unit_multiplier2',array_key_exists(1,$all_products)?@num_format($sub_units[$all_products[1]['sub_unit_ids'][0]]['multiplier']):null, ['class' => 'form-control input_number',array_key_exists(1,$all_products)?'disabled':'' ,'placeholder' => __( 'lang_v1.times_base_unit' )]); !!}
              </div>
            </div>
            <div class="col-sm-4">
              <div class="form-group">
                {!! Form::label('su_sell_price', __( 'lang_v1.su_sell_price' ) . ':') !!}
                {!! Form::number('su_sell_price[]',array_key_exists(1,$all_products)? @num_format($related_products[0]->variations[0]->su_sell_price):0, ['class' => 'form-control input_number','id'=>'su_sell_price2', 'placeholder' => __( 'lang_v1.su_sell_price' )]); !!}
              </div>
            </div>
            <div class="clearfix"></div>
            <!-- end 3k -->
            <!-- second sub unit data -->
            <div class="col-sm-4">
              <div class="form-group">
                {!! Form::label('actual_name', __( 'unit.subunit_name' ) . ':') !!}
                {!! Form::text('actual_name[]', array_key_exists(2,$all_products)?$sub_units[$all_products[2]['sub_unit_ids'][0]]['name']:null, ['class' => 'form-control',array_key_exists(2,$all_products)?'readonly':'' ,'placeholder' => __( 'unit.name' )]); !!}
                <input type="hidden" name="product_ids[]" value="{{array_key_exists(2,$all_products)?$all_products[2]['id']:''}}">
              </div>
            </div>
            <div class="col-sm-4">
              <div class="form-group">
                {!! Form::label('unit_id', __( 'lang_v1.times_base_unit' ) . ':') !!}
                {!! Form::number('base_unit_multiplier3', array_key_exists(2,$all_products)?@num_format($sub_units[$all_products[2]['sub_unit_ids'][0]]['multiplier']):null, ['class' => 'form-control input_number',array_key_exists(2,$all_products)?'disabled':'null' ,'placeholder' => __( 'lang_v1.times_base_unit' )]); !!}
              </div>
            </div>
            <div class="col-sm-4">
              <div class="form-group">
                {!! Form::label('su_sell_price', __( 'lang_v1.su_sell_price' ) . ':') !!}
                {!! Form::text('su_sell_price[]', array_key_exists(2,$all_products)?@num_format($related_products[1]->variations[0]->su_sell_price):0, ['class' => 'form-control input_number','id'=>'su_sell_price3' ,'placeholder' => __( 'lang_v1.su_sell_price' )]); !!}
              </div>
            </div>
            <div class="clearfix"></div>
            <!-- third sub unit -->
            <div class="col-sm-4">
              <div class="form-group">
                {!! Form::label('actual_name', __( 'unit.subunit_name' ) . ':') !!}
                {!! Form::text('actual_name[]', array_key_exists(3,$all_products)?$sub_units[$all_products[3]['sub_unit_ids'][0]]['name']:null, ['class' => 'form-control',array_key_exists(3,$all_products)?'readonly':'' ,'placeholder' => __( 'unit.name' )]); !!}
                <input type="hidden" name="product_ids[]" value="{{array_key_exists(3,$all_products)?$all_products[3]['id']:''}}">
              </div>
            </div>
            <div class="col-sm-4">
              <div class="form-group">
                {!! Form::label('base_unit_multiplier', __( 'lang_v1.times_base_unit' ) . ':') !!}
                {!! Form::text('base_unit_multiplier4', array_key_exists(3,$all_products)?@num_format($sub_units[$all_products[3]['sub_unit_ids'][0]]['multiplier']):0, ['class' => 'form-control input_number',array_key_exists(3,$all_products)?'disabled':'', 'placeholder' => __( 'lang_v1.times_base_unit' )]); !!}
              </div>
            </div>
            <div class="col-sm-4">
              <div class="form-group">
                {!! Form::label('su_sell_price', __( 'lang_v1.su_sell_price' ) . ':') !!}
                {!! Form::text('su_sell_price[]', array_key_exists(3,$all_products)?@num_format($related_products[2]->variations[0]->su_sell_price):0, ['class' => 'form-control input_number','id'=>'su_sell_price4', 'placeholder' => __( 'lang_v1.su_sell_price' )]); !!}
              </div>
            </div>
            <div class="clearfix"></div>
            <!-- end of 3k -->
