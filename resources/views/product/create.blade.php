...
<section class="content">
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="form-group">
        ...
        'id'=>'name','placeholder' => __('product.product_name')]); !!}
        <label id="name_alert" class="error" hidden> @lang('product.name_already_exists') . </label>
      </div>
    </div>
  ...
  <div class="col-sm-3">
    <div class="form-group">
      ...
      {!! Form::text('actual_name1', null, ['class' => 'form-control', 'required', 'placeholder' => __( 'unit.name' )]); !!}
    </div>
  </div>
  <div class="col-sm-3">
      <div class="form-group">
        ...
        'placeholder' => __('product.sku'),'id'=>'sku1']); !!}
        <label id="sku1_alert" class="error" hidden>@lang('product.sku_already_exists')</label>
      </div>
  </div>
  ...
  <div class="col-sm-3">
    <div class="form-group">
      ...
      {!! Form::text('single_dsp',null, ['class' => 'form-control input-sm dsp input_number', 'placeholder' => __('unit.exc_of_tax'), 'id' => 'single_dsp', 'required']); !!}
  ...
  <div class="col-sm-3">
    <div class="form-group">
      ...
      {!! Form::text('actual_name2', null, ['class' => 'form-control', 'placeholder' => __( 'unit.name' )]); !!}
    </div>
  </div>
  <div class="col-sm-3">
    <div class="form-group">
      {!! Form::label('sku2', __('product.sku') . ':') !!}
      {!! Form::text('sku[]', null, ['class' => 'form-control', 'id'=>'sku2' ]); !!}
      <label id="sku2_alert" class="error" hidden>@lang('product.sku_already_exists')</label>
    </div>
  </div>
  {{--<div class="col-sm-3">
      <div class="form-group">
  ...
  <div class="col-sm-3">
    <div class="form-group">
      ...
      {!! Form::number('base_unit_multiplier2', null, ['class' => 'form-control input_number', 'placeholder' => __( 'lang_v1.times_base_unit' )]); !!}
    </div>
  </div>
  <div class="col-sm-3">
    <div class="form-group">
      {!! Form::label('su_sell_price', __( 'lang_v1.su_sell_price' ) . ':') !!}
      {!! Form::number('su_sell_price[]', null, ['class' => 'form-control input_number','id'=>'su_sell_price2', 'placeholder' => __( 'lang_v1.su_sell_price' )]); !!}
    </div>
  </div>
  <div class="clearfix"></div>
  ...
  <div class="col-sm-3">
    <div class="form-group">
      ...
      {!! Form::text('actual_name3', null, ['class' => 'form-control', 'placeholder' => __( 'unit.name' )]); !!}
    </div>
  </div>
  <div class="col-sm-3">
    <div class="form-group">
      {!! Form::label('sku', __('product.sku') . ':') !!}
      {!! Form::text('sku[]', null, ['class' => 'form-control', 'id'=>'sku3']); !!}
      <label id="sku3_alert" class="error" hidden>@lang('product.sku_already_exists')</label>
    </div>
  </div>
  {{--<div class="col-sm-3">
      <div class="form-group">
  ...
  <div class="col-sm-3">
    <div class="form-group">
      ...
      {!! Form::number('base_unit_multiplier3', null, ['class' => 'form-control input_number', 'placeholder' => __( 'lang_v1.times_base_unit' )]); !!}
    </div>
  </div>
  <div class="col-sm-3">
    <div class="form-group">
      {!! Form::label('su_sell_price', __( 'lang_v1.su_sell_price' ) . ':') !!}
      {!! Form::number('su_sell_price[]', null, ['class' => 'form-control input_number','id'=>'su_sell_price3' ,'placeholder' => __( 'lang_v1.su_sell_price' )]); !!}
    </div>
  </div>
  <div class="clearfix"></div>
  <!-- third sub unit -->
  <div class="col-sm-3">
    <div class="form-group">
      {!! Form::label('actual_name', __( 'unit.subunit_name' ) . ':') !!}
      {!! Form::text('actual_name4', null, ['class' => 'form-control', 'placeholder' => __( 'unit.name' )]); !!}
    </div>
  </div>
  <div class="col-sm-3">
    <div class="form-group">
      {!! Form::label('sku', __('product.sku') . ':') !!}
      {!! Form::text('sku[]', null, ['class' => 'form-control', 'id'=>'sku4']); !!}
      <label id="sku4_alert" class="error" hidden>@lang('product.sku_already_exists')</label>
    </div>
  </div>
  {{--<div class="col-sm-3">
      <div class="form-group">
  ...
  <div class="col-sm-3">
    <div class="form-group">
      ...
      {!! Form::number('base_unit_multiplier4', null, ['class' => 'form-control input_number', 'placeholder' => __( 'lang_v1.times_base_unit' )]); !!}
    </div>
  </div>
  <div class="col-sm-3">
    <div class="form-group">
      {!! Form::label('su_sell_price', __( 'lang_v1.su_sell_price' ) . ':') !!}
      {!! Form::number('su_sell_price[]', null, ['class' => 'form-control input_number','id'=>'su_sell_price4', 'placeholder' => __( 'lang_v1.su_sell_price' )]); !!}
    </div>
  </div>
  <div class="clearfix"></div>
  <!--end 3k  -->
  <!-- commented units quick ad -->
  {{--<div class="col-sm-4 hide">
    ...
    <div class="col-sm-4 @if(!session('business.enable_sub_units')) hide @endif">
      <div class="form-group">
        ...
        <div class="input-group">
          {!! Form::select('sub_unit_ids[]', [], !empty($duplicate_product->sub_unit_ids) ? $duplicate_product->sub_unit_ids : null, ['class' => 'form-control select2', 'multiple', 'id' => 'sub_unit_ids','required']); !!}
          <span class="input-group-btn">
            <button type="button" @if(!auth()->user()->can('unit.create')) disabled @endif class="btn btn-default bg-white btn-flat btn-modal" data-href="{{action('UnitController@create', ['quick_add' => true])}}" title="@lang('unit.add_unit')" data-container=".view_modal"><i class="fa fa-plus-circle text-primary fa-lg"></i></button>
  </span>
  </div>
    ...
    <div class="col-sm-4 @if($hide) hide @endif">
      <div class="form-group">
        <div class="multi-input">
          ...
          'placeholder' => __('product.expiry_period'), 'style' => 'width:60%;','disabled'=>true]); !!}
          {!! Form::select('expiry_period_type', ['months'=>__('product.months'), 'days'=>__('product.days'), '' =>__('product.not_applicable') ], !empty($duplicate_product->expiry_period_type) ? $duplicate_product->expiry_period_type : '', ['class' => 'form-control select2 pull-left', 'style' => 'width:40%;', 'id' => 'expiry_period_type']); !!}
        </div>
      </div>
    </div>
    @endif
