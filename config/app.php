...
return [
    ...
    */
    ...
    'debug' => array_key_exists('APP_DEBUG', $_SERVER) ? ($_SERVER['APP_DEBUG'] === 'false' ? false : true) : env('APP_DEBUG', true),
    ...
    */
    ...
    'url' => array_key_exists('APP_URL', $_SERVER) ? $_SERVER['APP_URL'] : env('APP_URL', 'http://127.0.0.1/public'),
